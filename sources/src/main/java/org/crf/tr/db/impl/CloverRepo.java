...
import org.crf.tr.db.impl.InMemoryRepo.EntityConstraints;
import org.crf.tr.model.Project.TestFramework;
import org.crf.tr.services.CloverReportService;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CloverRepo <K, E> implements Repository< K, E >  {
	@Override
	...
	public final Optional<E> find(final K key) {
		final E entity = (E) CloverReportService.getProjectByIDFromMongo(key.toString());
	...
	public final Optional<E> store(final K key, final E entity) {
		...
		if (_store.putIfAbsent( key, entity ) == null) {
			CloverReportService.insertProjectToMongo(key.toString(), TestFramework.Clover, entity.toString());
